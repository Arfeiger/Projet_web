...
/**
 * Servlet implementation class MusiqueServlet
 */
@WebServlet("/MusiqueServlet")
public class MusiqueServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ResultSet res = ProductDao.catAll("Musique, Films et Jeux vidéo");
		...
		RequestDispatcher rd = request.getRequestDispatcher("/musique.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//		session.setAttribute("panierSucc","well done"); 
			    ...
			    response.sendRedirect("http://localhost:9080/projet_web/MusiqueServlet");
