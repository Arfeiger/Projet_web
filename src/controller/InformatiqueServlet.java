...
/**
 * Servlet implementation class InformatiqueServlet
 */
@WebServlet("/InformatiqueServlet")
public class InformatiqueServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public InformatiqueServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ResultSet res = ProductDao.catAll("High-Tech, Informatique, Bureau");
		...
		RequestDispatcher rd = request.getRequestDispatcher("/informatique.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if( request.getParameter("panier")!= null) {
			...
			//	session.setAttribute("panierSucc","well done"); 
			    ...
			    response.sendRedirect("http://localhost:9080/projet_web/InformatiqueServlet");
			}
